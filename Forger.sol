...
contract Forger is Ownable {
    ...
    function forge(
        ...
        _forge(forgeInIds, forgeInAmounts, forgeOutIds, forgeOutAmounts, multiplier);
    }
    ...
    function rule(
        ...
        bytes32 forgeId = _forgeId(forgeInIds, forgeInAmounts, forgeOutIds, forgeOutAmounts);

        forges[forgeId] = true;

        emit Rule(forgeId, forgeInIds, forgeInAmounts, forgeOutIds, forgeOutAmounts);
    }
    ...
    function _forgeId(
        ...
        return keccak256((abi.encode(forgeInIds, forgeInAmounts, forgeOutIds, forgeOutAmounts)));
    }

    function _multiply(uint[] memory numbers, uint multiplier) private pure returns (uint[] memory) {
